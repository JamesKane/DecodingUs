...
import play.silhouette.impl.providers.OpenIDInfo
 ...
 */
class OpenIDInfoDAO @Inject() (protected val dbConfigProvider: DatabaseConfigProvider)(implicit ex: ExecutionContext, val classTag: ClassTag[OpenIDInfo])
  extends DelegableAuthInfoDAO[OpenIDInfo] with AuthDAOSlick {
