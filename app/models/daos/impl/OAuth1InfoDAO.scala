 ...
 */
class OAuth1InfoDAO @Inject() (protected val dbConfigProvider: DatabaseConfigProvider)(implicit ex: ExecutionContext, val classTag: ClassTag[OAuth1Info])
  extends DelegableAuthInfoDAO[OAuth1Info] with AuthDAOSlick {
